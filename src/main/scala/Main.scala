...
object Main extends Serializable {
  ...
  def main(args: Array[String]): Unit = {
    ...
    def importData(fileName: String, sampleSize: Int): Array[(Int, Array[Double])] = {
      ...
      val lines = sc.textFile("gs://scala-and-spark/mnist_train_X.txt").take(sampleSize).toArray
...
//    val MNIST_PCA = sc.parallelize(importData("gs://scala-and-spark/resources/MNISTpca_n1000_k50", sampleSize))

    // testing tSNEsimple
//    val totalTime = System.nanoTime()
    println("Starting tSNEsimple")
